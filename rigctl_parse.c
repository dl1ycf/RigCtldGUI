/*
 * File taken from HAMLIB repository, file tests/rigctl_parse.c,
 * with the following modifications:
 *
 * #include "riglist.h"    ==>  #include <hamlib/riglist.h>
 *
 * and insertion of #undef HAVE_LIBREADLINE immediately after
 * including hamlib/config.h
 *
 */
